    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#0B0B0B] mb-2">Receive Leads</h3>
              <p className="text-[#374151] text-sm">Homeowners find you through search, categories, or request routing.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#0B0B0B] mb-2">Grow Your Business</h3>
              <p className="text-[#374151] text-sm">Build reviews, showcase your work, and win more Houston projects.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          <p className="text-[#374151] mb-10">Start free. Upgrade when you&apos;re ready.</p>
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="border rounded-xl p-6 text-left">
              <h3 className="font-bold text-[#0B0B0B] text-lg mb-1">Free</h3>
              <p className="text-[#6B7280] text-sm mb-4">Get started</p>
              <p className="text-3xl font-bold text-[#0B0B0B] mb-6">$0<span className="text-base font-normal text-[#6B7280]">/mo</span></p>
            ...
            <div className="border-2 border-[#0B0B0B] rounded-xl p-6 text-left relative">
              <div className="absolute -top-3 left-6 bg-[#0B0B0B] text-white text-xs px-3 py-1 rounded-full">Popular</div>
              <h3 className="font-bold text-[#0B0B0B] text-lg mb-1">Premium</h3>
              <p className="text-[#6B7280] text-sm mb-4">Grow faster</p>
              <p className="text-3xl font-bold text-[#0B0B0B] mb-6">$29<span className="text-base font-normal text-[#6B7280]">/mo</span></p>
              <ul className="space-y-2 text-sm text-[#374151]">
